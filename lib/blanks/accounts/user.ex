defmodule Blanks.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Blanks.Repo)
  ...
  """
  def valid_password?(%Blanks.Accounts.User{hashed_password: hashed_password}, password)
